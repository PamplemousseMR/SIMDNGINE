...
void emmintrin()
{
    ...
    */
    ...
    m128i = _mm_mulhi_epu16(m128i, m128i);                          //
    ...
    */
    ...
    m128i  = _mm_slli_epi16(m128i, 0);                              //
    m128i  = _mm_slli_epi32(m128i, 0);                              //
    m128i  = _mm_slli_epi64(m128i, 0);                              //
    m128i  = _mm_srai_epi16(m128i, 0);                              //
    m128i  = _mm_srai_epi32(m128i, 0);                              //
    m128i  = _mm_bsrli_si128(m128i, 0);                             //
    m128i  = _mm_bslli_si128(m128i, 0);                             //
    m128i  = _mm_srli_si128(m128i, 0);                              //
    m128i  = _mm_slli_si128(m128i, 0);                              //
    m128i  = _mm_srli_epi16(m128i, 0);                              //
    m128i  = _mm_srli_epi32(m128i, 0);                              //
    m128i  = _mm_srli_epi64(m128i, 0);                              //
    m128i  = _mm_sll_epi16(m128i, m128i);                           //
    m128i  = _mm_sll_epi32(m128i, m128i);                           //
    m128i  = _mm_sll_epi64(m128i, m128i);                           //
    m128i  = _mm_sra_epi16(m128i, m128i);                           //
    m128i  = _mm_sra_epi32(m128i, m128i);                           //
    m128i  = _mm_srl_epi16(m128i, m128i);                           //
    m128i  = _mm_srl_epi32(m128i, m128i);                           //
    m128i  = _mm_srl_epi64(m128i, m128i);                           // r[0:63] = count[0:63] > 63 ? r[0:63]=0 : r[0:63]=(ZeroExtend)(a[0:63]>>count[0:63]), r[64:127] = count[0:63] > 63 ? r[64:127]=0 : r[64:127]=(ZeroExtend(a[64:127]>>count[0:63]))
